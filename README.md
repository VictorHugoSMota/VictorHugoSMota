...
#### In addition, I have foundational knowledge of HTML, CSS, and JavaScript, which allows me to understand the complete development lifecycle and collaborate effectively on full-stack projects. Currently, I am expanding my skills in Docker, software architecture, design patterns, and observability using tools like Splunk, while continuously improving my English and preparing for a solid career as a software engineer.
...
### ⛃ Database
[![My Skills](https://skillicons.dev/icons?i=postgres,hibernate,mysql&theme=light)](https://skillicons.dev)
